...
ifneq ($(MCU_SUB_VARIANT),nrf52820)
CFLAGS += \
	-mfloat-abi=hard \
	-mfpu=fpv4-sp-d16
endif
...
# Populate SPI stuff to prevent undef build failures
ifeq ($(MCU_SUB_VARIANT),nrf52820)
CFLAGS += -DSPIM2_FEATURE_HARDWARE_CSN_PRESENT=0
CFLAGS += -DSPIM3_FEATURE_HARDWARE_CSN_PRESENT=0
CFLAGS += -DSPIM4_FEATURE_HARDWARE_CSN_PRESENT=0

CFLAGS += -DSPIM2_FEATURE_DCX_PRESENT=0
CFLAGS += -DSPIM3_FEATURE_DCX_PRESENT=0
CFLAGS += -DSPIM4_FEATURE_DCX_PRESENT=0

CFLAGS += -DSPIM2_FEATURE_RXDELAY_PRESENT=0
CFLAGS += -DSPIM3_FEATURE_RXDELAY_PRESENT=0
CFLAGS += -DSPIM4_FEATURE_RXDELAY_PRESENT=0

CFLAGS += -DSPIM2_EASYDMA_MAXCNT_SIZE=0
CFLAGS += -DSPIM3_EASYDMA_MAXCNT_SIZE=0
CFLAGS += -DSPIM4_EASYDMA_MAXCNT_SIZE=0
endif
